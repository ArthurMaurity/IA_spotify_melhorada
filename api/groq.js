...
const SYSTEM_PROMPT = [
  ...
  'HIP-HOP IS NOT ONE GENRE (mandatory): "rap" and "hip-hop" are umbrella tags, not micro-genres. Modern trap (808s, hi-hat rolls, autotune, contemporary production) must ONLY transition to other modern trap artists. NEVER transition from trap to boom bap, conscious rap or pop rap just because they share a country or the "rap" tag — e.g. Matuê does not lead to Emicida or Projota.',
  'ERA / DECADE STRICTNESS (mandatory): respect the timeline of the current track. Do not jump from a 2020s contemporary hit to 2010s or 90s tracks unless the listener explicitly asks for it. A modern trap song must lead to other modern trap songs; a 90s track should lead to tracks of that same era and production style.',
